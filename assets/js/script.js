...
var taskFormHandler = function (event) {
  ...
  //no data attribute, so xreate object as normal and pass to createTaskEl function
  else {
    var taskDataObj = {
      name: taskNameInput,
      type: taskTypeInput,
...
//gets task items fron localStorage
